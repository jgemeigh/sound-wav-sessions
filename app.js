...
function renderSiteCopy() {
  ...
  q("archive-copy").textContent = c.archive_copy || fallbackCopy.archive_copy || "";
  q("artists-title").textContent = c.artists_title || fallbackCopy.artists_title || "";
  q("artists-copy").textContent = c.artists_copy || fallbackCopy.artists_copy || "";
  q("affiliates-title").textContent = c.affiliates_title || fallbackCopy.affiliates_title || "";
  q("affiliates-copy").textContent = c.affiliates_copy || fallbackCopy.affiliates_copy || "";
  q("support-title").textContent = c.support_title || fallbackCopy.support_title || "";
  q("support-copy").textContent = c.support_copy || fallbackCopy.support_copy || "";
